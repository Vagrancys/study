 ...
 */
public abstract class BaseViewAdapter<T,VH extends BaseViewAdapter.CommonViewHolder> extends RecyclerView.Adapter<VH> {
    private List<T> list;
    ...
    public BaseViewAdapter(Context context,int layout,int footerId,int headerId,List<T> list){
        this(context,layout,footerId,list);
        this.headerId = headerId;
        this.IS_HEAD = true;
    }
    public BaseViewAdapter(Context context,int layout,int footerId,List<T> list){
